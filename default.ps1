...
properties {
	...
	$sln_file = "$src_directory\IdentityServer3.WsFederation.EntityFramework.sln"
...
task RunTests -depends Compile {
	$project = "IdentityServer3.WsFederation.EntityFramework.Tests"
...
task CreateNuGetPackage -depends Compile {
  ...
  copy-item $src_directory\IdentityServer3.WsFederation.EntityFramework.nuspec $dist_directory
  copy-item $output_directory\IdentityServer3.WsFederation.EntityFramework.dll $dist_directory\lib\net45
  copy-item $output_directory\IdentityServer3.WsFederation.EntityFramework.pdb $dist_directory\lib\net45
  
	exec { . $nuget_path pack $dist_directory\IdentityServer3.WsFederation.EntityFramework.nuspec -BasePath $dist_directory -o $dist_directory -version $packageVersion }
}
